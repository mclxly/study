...
#server {
  ...
  #server_name blog.stt.newbiiz.com;

  # and redirect to the non-www host (declared below)
  #eturn 301 $scheme://stt.newbiiz.com$request_uri;
#}
...
server {
  ...
  root /data/www/stt2013yii/blog;
  index index.php;
  access_log /var/log/nginx/blog.stt.access;
  error_log /var/log/nginx/blog.stt.error error; 
