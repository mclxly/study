AppEmber.ArtistRoute = Ember.Route.extend({
  model: function(params) {
    ...
    */
   var url = "http://developer.echonest.com/api/v4/artist/profile?api_key=FKB3XXRCTDVSDI7WI&format=json&bucket=biographies&bucket=blogs&bucket=familiarity&bucket=hotttnesss&bucket=images&bucket=news&bucket=reviews&bucket=terms&bucket=urls&bucket=video&bucket=id:musicbrainz",
    obj = {"id": params.enid};
